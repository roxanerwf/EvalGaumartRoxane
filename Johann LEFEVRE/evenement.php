...
<body>
    ...
    <div id="textegauche">
        ...
        <center>
            <h3><b>Evènements privés </b></h3>
        </center><br/>

        <p id="textestyle">Organisation de votre dîner haut de gamme à Paris.<br/> Pompeius iuris ludaeis provinciae calentes aptae<br/> medalrum navigerum nusquam multiplicium navigerum<br/> plurimis navigerum sorte delata et plurimis navigerum<br/> ludaeis in.</p>
