...
<head>
    ...
    <link href="assets/css/traiteur.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div id="textegauche">
        ...
        <center>
            <h4><b>Traiteur et Organisateur de Réception </b></h4>
        </center><br/>

        <p id="textestyle">Depuis plus de 25 ans, nous organisons<br/> vos cocktails, buffets, réceptions, ...<br/>
            <br/> Toutes nos propositions sont personnalisées<br/> pour répondre au mieux à vos attentes.</p>
